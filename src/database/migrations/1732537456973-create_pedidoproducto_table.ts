...
export class CreatePedidoproductoTable1732537456973 implements MigrationInterface {
    name = 'CreatePedidoproductoTable1732537456973'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "pedido_producto" ("id" SERIAL NOT NULL, "pedidoID" character varying NOT NULL, "productoID" character varying NOT NULL, "cantidad" integer NOT NULL, "pedidoId" integer, "productoId" integer, CONSTRAINT "PK_97f69aaf286bdd82afbd487e4d5" PRIMARY KEY ("id"))`);
